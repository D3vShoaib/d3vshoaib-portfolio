...
export const metadata: Metadata = {
  title: "Blogs - Shoaib Ahmad",
  description: "Shoaib Ahmad's Blog, fragments of my imagination",
  keywords:
    "Shoaib Ahmad, blog, nextjs, react, javascript, typescript, web development, programming",
  alternates: {
